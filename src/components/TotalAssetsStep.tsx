      ...
      <div className="relative overflow-hidden rounded-xl mb-6">
        ...
        <div className="relative p-6 text-[#103D55]">
          ...
          <p className="text-sm opacity-90">
            Total assets include all assets of the corporation, regardless of their location. This includes 
            cash, accounts receivable, inventory, investments, fixed assets, and intangible assets.
          </p>
        </div>
      </div>
